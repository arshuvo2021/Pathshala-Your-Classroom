...
if(isset($_SESSION['name'])){ 
    ...
    if($_SESSION['role']=="Teacher"){ ?>
        <script>window.location="webDashboardT.php";</script>

    <?php } 
    else{ ?>
        <script>window.location="webDashboardS.php";</script>
...
<body>
    <nav class="navbar navbar-dark w-100 upperNav">
        <div class="container-fluid">
            ...
            <div class="header_icon">
                <a href="https://www.facebook.com"><i class="fab fa-facebook-f fabCust"></i></a>
                <a href="https://twitter.com/?lang=en"><i class="fab fa-twitter ml-2 fabCust"></i></a>
                <a href="https://bd.linkedin.com/"><i class="fab fa-linkedin-in ml-2 fabCust"></i></a>
            </div>
        </div>
    </nav>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse ml-5" id="navbarNav">
                        <ul class="navbar-nav ml-4 mr-5">
                            ...
                            <li class="nav-item">
                                <a class="nav-link navLinkCust" data-mdb-toggle="modal" data-mdb-target="#exampleModal">CLassroom</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link navLinkCust" href="#bottomH">About Us</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link navLinkCust" href="#bottomH">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row my-3" id="bottomH">
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="card innerCard">
                    <div class="card-body">
                        <h5 class="card-title text-center">Why Pathshala?</h5>
                        <p class="card-text">We can use our platform to create a relationship  between teacher and students via online.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="card innerCard">
                    <div class="card-body">
                        ...
                        <p class="card-text">Easy Communication<br>Virtual Connection<br>Knowledge exploration</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="card innerCard">
                    <div class="card-body">
                        ...
                        <p class="card-text">52/8 West Raza Bazar(Main Office)<br>332 Rosulpur(Sub-Office)<br>Mail : amaderemail@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
