            ...
            <div class="navbar-header mainav">
                <div class="dboard">
                    ...
                    <div id="mySidepanel" class="sidepanel" windows.load=>
                        ...
                        <form method="post">
                            <input type="submit" class="btn btn-danger btn-sm logout mt-3" value="Logout"
                                name="logout"></input>
                        </form>
                        <?php 
                ...
                <div class="userName">
                    <a href="#" class="adminName text-decoration-none font-weight-bold"><i class="fa fa-user" aria-hidden="true"></i>
